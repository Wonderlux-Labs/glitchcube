    ...
    module Api
      ...
      module Deployment
        def self.registered(app)
          ...
          app.post '/api/v1/deploy/webhook' do
            ...
            begin
              ...
              validate_github_signature!(request, payload_body) if GlitchCube.config.deployment&.github_webhook_secret
              ...
              Services::Logging::SimpleLogger.info('GitHub webhook deployment request',
              ...
              status 500
              Services::Logging::SimpleLogger.error('GitHub webhook deployment error',
          ...
          app.post '/api/v1/deploy/internal' do
            ...
            begin
              ...
              Services::Logging::SimpleLogger.info('Internal deployment request',
              ...
              status 500
              Services::Logging::SimpleLogger.error('Internal deployment error',
          ...
          app.get '/api/v1/deploy/status' do
            ...
            begin
              ...
              json({
                     ...
                     needs_update: behind_count.positive?,
        ...
        def self.validate_github_signature!(request, payload_body)
          ...
          raise SecurityError, 'Missing GitHub signature header' unless signature
        ...
        def self.execute_deployment(deployment_info)
          ...
          begin
            ...
            Services::Logging::SimpleLogger.info('Pulling latest changes from git...', tagged: %i[deployment git])
            ...
            Services::Logging::SimpleLogger.info('Syncing configuration to Home Assistant...', tagged: %i[deployment config])
            ...
            if config_result
              Services::Logging::SimpleLogger.info('Restarting Home Assistant...', tagged: %i[deployment ha_restart])
            ...
            if git_result
              Services::Logging::SimpleLogger.info('Restarting Glitch Cube services...', tagged: %i[deployment service_restart])
          ...
          Services::Logging::SimpleLogger.info('Deployment execution completed',
        ...
        def self.restart_services
          ...
          if system('docker-compose ps > /dev/null 2>&1')
            Services::Logging::SimpleLogger.info('Restarting Docker services...', tagged: %i[deployment docker])
            return system('docker-compose restart glitchcube sidekiq')
          end

          # For systemd deployment
          if system('systemctl is-active glitchcube.service > /dev/null 2>&1')
            Services::Logging::SimpleLogger.info('Restarting systemd services...', tagged: %i[deployment systemd])
          ...
          Services::Logging::SimpleLogger.warn('No automatic service restart method detected', tagged: %i[deployment warning])
          true
        rescue StandardError => e
          Services::Logging::SimpleLogger.error('Service restart failed', tagged: %i[deployment error], error: e.message)
          false
        end
      end
    end
