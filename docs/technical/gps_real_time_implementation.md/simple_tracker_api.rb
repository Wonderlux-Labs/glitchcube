...
AIRPORT_LOCATION = { lat: 40.6622, lng: -119.4341 } # Black Rock City Airport
...
def get_location_context(lat, lng)
  ...
  if distance_to_reno < 20
    ...
    clock_hour = clock_hour > 12 ? clock_hour - 12 : clock_hour
    clock_hour = clock_hour == 0 ? 12 : clock_hour
