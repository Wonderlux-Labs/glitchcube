  ...
  describe 'AWTRIX Display Control' do
    describe '#awtrix_display_text' do
      ...
      it 'handles errors gracefully' do
        ...
        expect(client.awtrix_display_text('Test')).to eq(false)
      end
    end
    ...
    describe '#awtrix_notify' do
      ...
      it 'handles errors gracefully' do
        ...
        expect(client.awtrix_notify('Test')).to eq(false)
      end
    end
    ...
    describe '#awtrix_clear_display' do
      ...
      it 'handles errors gracefully' do
        ...
        expect(client.awtrix_clear_display).to eq(false)
      end
    end
    ...
    describe '#awtrix_mood_light' do
      ...
      it 'handles errors gracefully' do
        ...
        expect(client.awtrix_mood_light('#FFFFFF')).to eq(false)
      end
    end
  end
end