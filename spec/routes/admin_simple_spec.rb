...
RSpec.describe 'Simple Admin Interface' do
  describe 'GET /admin/simple' do
    ...
    it 'has minimal JavaScript functions' do
      get '/admin/simple'
      ...
      # Should NOT have complex functions from advanced version
      expect(last_response.body).not_to include('loadMemories')
      expect(last_response.body).not_to include('switchMemoryTab')
    end
  end

  describe 'POST /admin/proactive_conversation' do
    it 'creates a conversation session with proactive message' do
